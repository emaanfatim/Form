...
namespace Project132 {
    ...
    private:
        ...
        /// <summary>
        /// Function to find the teacher teaching at a specific time on a given day
        /// </summary>
        String^ FindTeacherByTimeAndDay(String^ time, String^ day) {
            for (int i = 0; i < numberOfStudents; i++) {
                // Check if the student has a class at the specified time and day
                if (studentTimes[i]->Equals(time) && studentDays[i]->Equals(day)) {
                    return studentNames[i]; // Return the name of the teacher
                }
            }
            return "No teacher found"; // Return if no teacher is found at the specified time and day
        }
        ...
        void DisplayTimetableForDay(String^ day) {
            ...
            for (int i = 0; i < numberOfStudents; i++) {
                // Check if the student has a class on the specified day
                if (studentDays[i]->Equals(day)) {
                    // Construct the information for the class
                    String^ classInfo = String::Format("Course: {0}, Teacher: {1}, Room: {2}, Time: {3}",
                        studentCourses[i], studentNames[i], studentRoom[i], studentTimes[i]);
                    listBoxStudents->Items->Add(classInfo); // Add class info to the list box
                }
            }
        }
        ...
        // Function to display data for all students
...
#pragma region Windows Form Designer generated code
        void InitializeComponent(void)
        {
            ...
            this->removeButton->Click += gcnew System::EventHandler(this, &Teacherwise::removeButton_Click);
            // 
            // showDataButton
            // 
            this->showDataButton->Location = System::Drawing::Point(291, 299);
            this->showDataButton->Margin = System::Windows::Forms::Padding(4);
            ...
            this->label3->Location = System::Drawing::Point(289, 85);
            ...
            this->label4->Location = System::Drawing::Point(289, 117);
            ...
            this->label5->Location = System::Drawing::Point(289, 149);
            ...
            this->label6->Location = System::Drawing::Point(289, 179);
